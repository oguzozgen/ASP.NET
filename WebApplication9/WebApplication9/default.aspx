...
<body>
    ...
    <div>
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ders_id" DataSourceID="SqlDataSource2">
            <Columns>
                ...
                <asp:TemplateField HeaderText="sinif" SortExpression="sinif">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList3" runat="server" SelectedValue='<%# Bind("sinif") %>'>
                ...
                <asp:TemplateField HeaderText="donem" SortExpression="donem">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList4" runat="server" SelectedValue='<%# Bind("donem") %>'>
                            <asp:ListItem Value="g">Güz</asp:ListItem>
                            <asp:ListItem Value="b">Bahar</asp:ListItem>
                        </asp:DropDownList>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("donem") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <p>
            ders kodu<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
        </p>
        <p>
            ders adi
